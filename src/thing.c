...
extern bool handle_get_request_on_resource_capability_audiovolume_main_0(st_things_get_request_message_s* req_msg, st_things_representation_s* resp_rep);
extern bool handle_set_request_on_resource_capability_audiovolume_main_0(st_things_set_request_message_s* req_msg, st_things_representation_s* resp_rep);
extern bool handle_get_request_on_resource_capability_mediainputsource_main_0(st_things_get_request_message_s* req_msg, st_things_representation_s* resp_rep);
extern bool handle_set_request_on_resource_capability_mediainputsource_main_0(st_things_set_request_message_s* req_msg, st_things_representation_s* resp_rep);
extern bool handle_get_request_on_resource_capability_mediaplayback_main_0(st_things_get_request_message_s* req_msg, st_things_representation_s* resp_rep);
extern bool handle_set_request_on_resource_capability_mediaplayback_main_0(st_things_set_request_message_s* req_msg, st_things_representation_s* resp_rep);
extern bool handle_get_request_on_resource_capability_mediatrackcontrol_main_0(st_things_get_request_message_s* req_msg, st_things_representation_s* resp_rep);
extern bool handle_set_request_on_resource_capability_mediatrackcontrol_main_0(st_things_set_request_message_s* req_msg, st_things_representation_s* resp_rep);
extern bool handle_get_request_on_resource_capability_mediaplaybackrepeat_main_0(st_things_get_request_message_s* req_msg, st_things_representation_s* resp_rep);
extern bool handle_set_request_on_resource_capability_mediaplaybackrepeat_main_0(st_things_set_request_message_s* req_msg, st_things_representation_s* resp_rep);
extern bool handle_get_request_on_resource_capability_mediaplaybackshuffle_main_0(st_things_get_request_message_s* req_msg, st_things_representation_s* resp_rep);
extern bool handle_set_request_on_resource_capability_mediaplaybackshuffle_main_0(st_things_set_request_message_s* req_msg, st_things_representation_s* resp_rep);
extern bool handle_get_request_on_resource_capability_audiotrackdata_main_0(st_things_get_request_message_s* req_msg, st_things_representation_s* resp_rep);
...
bool handle_get_request(st_things_get_request_message_s* req_msg, st_things_representation_s* resp_rep)
{
    ...
    if (0 == strcmp(req_msg->resource_uri, RES_CAPABILITY_AUDIOVOLUME_MAIN_0)) {
        return handle_get_request_on_resource_capability_audiovolume_main_0(req_msg, resp_rep);
    }
    if (0 == strcmp(req_msg->resource_uri, RES_CAPABILITY_MEDIAINPUTSOURCE_MAIN_0)) {
        return handle_get_request_on_resource_capability_mediainputsource_main_0(req_msg, resp_rep);
    }
    if (0 == strcmp(req_msg->resource_uri, RES_CAPABILITY_MEDIAPLAYBACK_MAIN_0)) {
        return handle_get_request_on_resource_capability_mediaplayback_main_0(req_msg, resp_rep);
    }
    if (0 == strcmp(req_msg->resource_uri, RES_CAPABILITY_MEDIATRACKCONTROL_MAIN_0)) {
        return handle_get_request_on_resource_capability_mediatrackcontrol_main_0(req_msg, resp_rep);
    }
    if (0 == strcmp(req_msg->resource_uri, RES_CAPABILITY_MEDIAPLAYBACKREPEAT_MAIN_0)) {
        return handle_get_request_on_resource_capability_mediaplaybackrepeat_main_0(req_msg, resp_rep);
    }
    if (0 == strcmp(req_msg->resource_uri, RES_CAPABILITY_MEDIAPLAYBACKSHUFFLE_MAIN_0)) {
        return handle_get_request_on_resource_capability_mediaplaybackshuffle_main_0(req_msg, resp_rep);
    }
    if (0 == strcmp(req_msg->resource_uri, RES_CAPABILITY_AUDIOTRACKDATA_MAIN_0)) {
        return handle_get_request_on_resource_capability_audiotrackdata_main_0(req_msg, resp_rep);
    }
...
bool handle_set_request(st_things_set_request_message_s* req_msg, st_things_representation_s* resp_rep)
{
    ...
    if (0 == strcmp(req_msg->resource_uri, RES_CAPABILITY_AUDIOVOLUME_MAIN_0)) {
        return handle_set_request_on_resource_capability_audiovolume_main_0(req_msg, resp_rep);
    }
    if (0 == strcmp(req_msg->resource_uri, RES_CAPABILITY_MEDIAINPUTSOURCE_MAIN_0)) {
        return handle_set_request_on_resource_capability_mediainputsource_main_0(req_msg, resp_rep);
    }
    if (0 == strcmp(req_msg->resource_uri, RES_CAPABILITY_MEDIAPLAYBACK_MAIN_0)) {
        return handle_set_request_on_resource_capability_mediaplayback_main_0(req_msg, resp_rep);
    }
    if (0 == strcmp(req_msg->resource_uri, RES_CAPABILITY_MEDIATRACKCONTROL_MAIN_0)) {
        return handle_set_request_on_resource_capability_mediatrackcontrol_main_0(req_msg, resp_rep);
    }
    if (0 == strcmp(req_msg->resource_uri, RES_CAPABILITY_MEDIAPLAYBACKREPEAT_MAIN_0)) {
        return handle_set_request_on_resource_capability_mediaplaybackrepeat_main_0(req_msg, resp_rep);
    }
    if (0 == strcmp(req_msg->resource_uri, RES_CAPABILITY_MEDIAPLAYBACKSHUFFLE_MAIN_0)) {
        return handle_set_request_on_resource_capability_mediaplaybackshuffle_main_0(req_msg, resp_rep);
    }

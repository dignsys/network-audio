...
bool handle_get_request_on_resource_capability_mediainputsource(st_things_get_request_message_s* req_msg, st_things_representation_s* resp_rep)
{
...
bool handle_set_request_on_resource_capability_mediainputsource(st_things_set_request_message_s* req_msg, st_things_representation_s* resp_rep)
{
